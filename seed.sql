DELETE IF EXISTS FROM yarn_table;
DELETE IF EXISTS FROM size;
DELETE IF EXISTS FROM fiber_type ;
...
INSERT INTO yarn_table (name_, brand, size_id, fiber_type1, color, length_, quantity) VALUES ('Yarn Bee True Colors', 'Hobby Lobby', 7, 2, 'Mauve', 76, 2);
...
INSERT INTO yarn_table (name_, brand, size_id, fiber_type1, color, length_, quantity) VALUES ('Super Saver Jumbo Stripes', 'Red Heart', 5, 2, 'Newspaper Stripe', 482, 2);
INSERT INTO yarn_table (name_, brand, size_id, fiber_type1, color, length_, quantity) VALUES ('Bernat Baby Sport', 'Yarnspirations', 4, 2, 'Baby Ecru', 1256, 1);
INSERT INTO yarn_table (name_, brand, size_id, fiber_type1, color, length_, quantity) VALUES ('Hometown', 'Lion Brand', 7, 2, 'Pink', 81, 3);
INSERT INTO yarn_table (name_, brand, size_id, fiber_type1, fiber_type2, color, length_, quantity) VALUES ('I Baby Bee Sweet Delight Prints', 'Hobby Lobby', 4, 2, 3, 'Sprinkles', 377, 1);